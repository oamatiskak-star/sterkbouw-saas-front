export default function Page() {
  return (
    ...
    <a href="/investeringen/haalbaarheid" className="btn btn-primary me-2 mb-2">
      Haalbaarheid
    </a>
  
    <a href="/investeringen/scenarios" className="btn btn-primary me-2 mb-2">
      Scenario’s
    </a>
  
    <a href="/investeringen/rendement" className="btn btn-primary me-2 mb-2">
      Rendement
    </a>
