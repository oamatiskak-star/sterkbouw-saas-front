...
export default function DashboardPage() {
  ...
  return (
    <div className="d-flex">
      {/* Linker menu */}
      <div className="menu bg-light border-end" style={{ width: '250px', minHeight: '100vh' }}>
        <div className="p-3 border-bottom">
          <h2 className="h5 mb-0 fw-bold">Bouw Management</h2>
        </div>
        <ul className="list-unstyled mb-0">
          <li><Link href="/dashboard" className="menu-link d-block py-3 px-3 text-decoration-none border-start border-3 border-primary bg-primary-subtle"><i className="ti ti-dashboard me-2"></i>Dashboard</Link></li>
          <li><Link href="/administratie" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-building-bank me-2"></i>Administratie</Link></li>
          <li><Link href="/bim" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-cube me-2"></i>BIM</Link></li>
          <li><Link href="/bouwplaats" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-building-warehouse me-2"></i>Bouwplaats</Link></li>
          <li><Link href="/calculatie" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-calculator me-2"></i>Calculatie</Link></li>
          <li><Link href="/constructie" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-building me-2"></i>Constructie</Link></li>
          <li><Link href="/documenten" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-files me-2"></i>Documenten</Link></li>
          <li><Link href="/financien" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-currency-euro me-2"></i>Financiën</Link></li>
          <li><Link href="/financieringen" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-pig-money me-2"></i>Financieringen</Link></li>
          <li><Link href="/inkoop" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-shopping-cart me-2"></i>Inkoop</Link></li>
          <li><Link href="/kopersportaal" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-user me-2"></i>Kopersportaal</Link></li>
          <li><Link href="/mail" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-mail me-2"></i>Mail</Link></li>
          <li><Link href="/planning" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-calendar me-2"></i>Planning</Link></li>
          <li><Link href="/projecten" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-building me-2"></i>Projecten</Link></li>
          <li><Link href="/projectportaal" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-world me-2"></i>Projectportaal</Link></li>
          <li><Link href="/instellingen" className="menu-link d-block py-3 px-3 text-decoration-none"><i className="ti ti-settings me-2"></i>Instellingen</Link></li>
        </ul>
      </div>
