    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
      <div className="mx-auto w-full max-w-5xl px-4 py-10">
        ...
        <div className="flex flex-col gap-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-slate-600">Maak een project aan en koppel de klant.</p>
                </div>
                <div className="grid gap-4 md:grid-cols-2">
                  <input className="h-11 w-full rounded border border-slate-300 px-3" placeholder="Project ID" value={projectId} onChange={(e) => setProjectId(e.target.value)} />
                  <input className="h-11 w-full rounded border border-slate-300 px-3" placeholder="Projectnaam" value={project.name} onChange={(e) => setProject({ ...project, name: e.target.value })} />
                </div>
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleCreateProject} disabled={!canCreateProject}>Maak project aan</button>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-slate-600">Projecttype, begroting en scenario.</p>
                </div>
                <div className="grid gap-4 md:grid-cols-2">
                  ...
                  <input className="h-11 w-full rounded border border-slate-300 px-3" placeholder="Scenario naam" value={settings.scenario_name} onChange={(e) => setSettings({ ...settings, scenario_name: e.target.value })} />
          ...
          <section className={getStepClasses(4)}>
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleUploadFiles} disabled={!canUploadFiles}>{isUploading ? 'Uploaden...' : 'Upload bestanden'}</button>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className={getStepClasses(8)}>
            <div className="flex items-start gap-4">
              <div className={getStepNumberClasses(8)}>8</div>
              <div className="flex-1">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-slate-900">Stap 8 - Risico analyse</h2>
                  <p className="text-sm text-slate-600">Analyseer risico's voor het project.</p>
                </div>
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleRiskAnalysis} disabled={!projectId}>Risico analyse</button>
                </div>
              </div>
            </div>
          </section>

          <section className={getStepClasses(9)}>
            <div className="flex items-start gap-4">
              <div className={getStepNumberClasses(9)}>9</div>
              <div className="flex-1">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-slate-900">Stap 9 - Maak planning</h2>
                  <p className="text-sm text-slate-600">Genereer een planning voor het project.</p>
                </div>
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handlePlanning} disabled={!canPlan}>Maak planning</button>
                </div>
              </div>
            </div>
          </section>

          <section className={getStepClasses(10)}>
            <div className="flex items-start gap-4">
              <div className={getStepNumberClasses(10)}>10</div>
              <div className="flex-1">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-slate-900">Stap 10 - Deel calculatie</h2>
                  <p className="text-sm text-slate-600">Splits de calculatie waar nodig.</p>
                </div>
                <div className="grid gap-4">
                ...
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleSplitCalculation} disabled={!projectId || !splitRequest}>Deel calculatie</button>
                </div>
              </div>
            </div>
          </section>

          <section className={getStepClasses(11)}>
            <div className="flex items-start gap-4">
              <div className={getStepNumberClasses(11)}>11</div>
              <div className="flex-1">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-slate-900">Stap 11 - Fixed price toepassen</h2>
                  <p className="text-sm text-slate-600">Pas een vaste prijs toe indien nodig.</p>
                </div>
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleFixedPrice} disabled={!projectId || !settings.fixed_price}>Fixed price toepassen</button>
                </div>
              </div>
            </div>
          </section>

          <section className={getStepClasses(12)}>
            <div className="flex items-start gap-4">
              <div className={getStepNumberClasses(12)}>12</div>
              <div className="flex-1">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-slate-900">Stap 12 - Maak offerte</h2>
                  <p className="text-sm text-slate-600">Maak de offerte aan voor het project.</p>
                </div>
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleOfferGenerate} disabled={!canOffer}>Maak offerte</button>
                </div>
              </div>
            </div>
          </section>

          <section className={getStepClasses(13)}>
            <div className="flex items-start gap-4">
              <div className={getStepNumberClasses(13)}>13</div>
              <div className="flex-1">
                <div className="mb-4">
                  <h2 className="text-xl font-semibold text-slate-900">Stap 12 - Download PDF</h2>
                  <p className="text-sm text-slate-600">Download de definitieve PDF.</p>
                </div>
                {pdfUrl && <p className="mb-4 text-sm text-slate-600">{pdfUrl}</p>}
                <div className="mt-6 flex justify-end">
                  <button className="rounded bg-slate-900 px-5 py-2.5 text-white" onClick={handleDownloadPdf} disabled={!canDownloadPdf}>Download PDF</button>
                </div>
              </div>
            </div>
          </section>
