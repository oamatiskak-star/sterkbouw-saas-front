...
const BadkamerModel = {
  ...
  advancedInputs: [
    ...
    { key: 'radiator', label: 'Designradiator', type: 'choice', default: 'nee', opties: [['nee', 'Nee'], ['ja', 'Ja']] },
  ...
  bereken(v) {
    ...
    if (ja(v.radiator)) regels.push({ combiCode: 'CUR-2803', hoeveelheid: 1, omschrijving: 'Designradiator' });
