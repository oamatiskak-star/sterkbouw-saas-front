...
const IsolatieModel = {
  ...
  advancedInputs: [
    // Spec-velden (vastgelegd als aanname; sturen prijs pas zodra combi-varianten per dikte/Rc bestaan).
    { key: 'dikte_mm', label: 'Dikte', type: 'number', eenheid: 'mm', default: '' },
    { key: 'lambda', label: 'Warmtegeleiding λ', type: 'number', eenheid: 'W/mK', default: '' },
    { key: 'rc_waarde', label: 'Warmteweerstand Rc', type: 'number', eenheid: 'm²K/W', default: '' },
