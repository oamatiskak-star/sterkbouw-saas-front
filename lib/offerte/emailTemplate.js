...
export function buildOfferteEmail({ klantNaam, projectnaam, portalUrl, afzenderNaam, bedrijfNaam, reviewUrl, notitie }) {
  ...
  const noot = notitie ? esc(notitie) : null;
    ...
    <tr><td align="center">
      <table role="presentation" width="560" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;">
        ...
        <tr><td style="padding:36px 32px 8px;">
          ...
          ${noot ? `<table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 24px;"><tr><td style="background:#FAFAF8;border-left:3px solid #C9A227;border-radius:6px;padding:14px 16px;font-size:14px;line-height:1.6;color:#374151;">${noot}</td></tr></table>` : ''}
