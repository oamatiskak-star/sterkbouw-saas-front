...
// lib/notifyLead.js (Mailtrap primair, Resend fallback, no-op zonder provider-key) — geen
// tweede mail-infra, hergebruik van dezelfde envs.
...
export async function verstuurOfferteMail({ to, replyTo, subject, html, text }) {
  ...
  const fromName = process.env.LEADS_FROM_NAME || 'STRKBOUW';
